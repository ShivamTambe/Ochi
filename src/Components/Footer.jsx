        ...
        <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
            <div className="w-1/2 flex flex-col justify-between h-full">
                <div className="heading">
                    <h1 className='text-[5vw] font-semibolad leading-none uppercase mb-1'>Eye-</h1>
                    <h1 className='text-[5vw] font-semibold leading-none uppercase mb-1'>Opening</h1>
                </div>
            ...
            <div className="w-1/2 flex flex-col justify-between h-full">
                <div className="heading">
                    <h1 className='text-[5vw] font-semibolad leading-none uppercase mb-1'>
                        Presentations
                    </h1>
